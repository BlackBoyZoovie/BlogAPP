...
func (server *Server) UpdatePost(w http.ResponseWriter, r *http.Request) {
	...
	// if a user attempt to update a psot belonging to him
	if uid != post.AuthorID {
		responses.ERROR(w, http.StatusUnauthorized, errors.New("Unauthorized"))
		return
	}
	...
	// Also check if the user id is equal to the one from the token
	...
	postUpdate.ID = post.ID // This is important to tell the model the post id to update
...
func (server *Server) DeletePost(w http.ResponseWriter, r *http.Request) {
	...
	// Is the authenticated user the owner of the post?
	if uid != post.AuthorID {
		responses.ERROR(w, http.StatusUnauthorized, errors.New("Unauthorized"))
		return
	}
